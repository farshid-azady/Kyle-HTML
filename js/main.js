	...
	if ($("#contact-form").length) {
        $("#contact-form").validate({
            ...
            messages: {
                ...
                email: "لطفا آدرس ایمیل خود را وارد کنید"
            },
...
$("#subscribe").submit(function (e)
{
    ...
    $.ajax({
                ...
                data: $(e).serialize(),
                success: function () {
                        $('#show_subscriber_msg').html('<div class=gen>سپاسگذاریم، شما با موفقیت در خبرنامه ما عضو شدید.</div>');
                    
                },
                error: function () {
                        $('#show_subscriber_msg').html('<div class=err>متاسفیم، خطایی رخ داده است لطفا دوباره سعی کنید!</div>');
                }
            });
    e.preventDefault();
});
